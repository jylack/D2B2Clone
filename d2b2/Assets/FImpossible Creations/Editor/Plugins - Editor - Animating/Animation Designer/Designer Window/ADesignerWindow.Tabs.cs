...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        public void DrawPlaybackSpeedSlider()
        {
            ...
            EditorGUILayout.LabelField(new GUIContent( "\n(" + System.Math.Round(animationElapsed / _play_mod_Length, 2).ToString("0.00") + ")", "Current animation preview normalized time (0-1) progress value"), EditorStyles.centeredGreyMiniLabel, GUILayout.MaxWidth(40));
